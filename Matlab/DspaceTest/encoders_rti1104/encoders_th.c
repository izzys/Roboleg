/************************ dSPACE target specific file *************************
   ...
   Include file .\encoders_rti1104\encoders_th.c :

   Task Configuration file for model : encoders

   RTI1104 7.3 (02-Nov-2014)/2.6
   29-Jul-2015 19:29:40
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\encoders_rti1104\encoders_th.c is for ST).
# endif
