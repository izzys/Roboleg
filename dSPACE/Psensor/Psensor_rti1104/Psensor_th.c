/************************ dSPACE target specific file *************************
   ...
   Include file .\Psensor_rti1104\Psensor_th.c :

   Task Configuration file for model : Psensor

   RTI1104 7.3 (02-Nov-2014)/2.6
   30-Nov-2015 11:37:19
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Psensor_rti1104\Psensor_th.c is for ST).
# endif
